...
if (isset($_POST['edit'])) {
  ...
  mysql_query("update users set name='$name',email='$email',pnumber='$pnumber' where id='$id'");
 ...
 <div class="span6">
  ...
  <div class="span6">
    <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Personal-info</h5>
          <a href="upload.php?id=<?php echo $fetch['id']; ?>"><span class="pull-right"><h5>Change profile picture</h5></span></a>
        </div>
        <div class="widget-content nopadding">
        <center><img src="../Images/<?php echo $fetch['image']; ?>"></center>
