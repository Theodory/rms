...
if (isset($_POST['register'])) {
  ...
  $description = $_POST['description'];
      ...
      if(mysql_query("insert into alumni values('','$program','$region','$start','$finish','$description')")){
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> > Alumni Programmes</div>
  </div>
<!--End-breadcrumbs-->
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-th"></i></span>
          ...
          ?>
                <tr class="odd gradeX">
                  ...
                  <td class="center"><a href="alumni_view.php?id=<?php echo $fetch['id'] ?>"><i title="view programme" class="icon icon-eye-open "></i></a>| <a href="alumni_edit.php?id=<?php echo $fetch['id'] ?>"><i title="edit" class="icon icon-edit "></i></a> | <a href="alumni_delete.php?id=<?php echo $fetch['id'] ?>"><i title="delete" class="icon icon-trash"></i></a>|<a href="alumni_programme_partcipants.php?id=<?php echo $fetch['id'];?>"><span class="label label-info">Participants</span></a></td>
