...
if (isset($_POST['edit'])) {
  ...
  if(mysql_query("update teachers set program='$program',school='$school',region='$region', participants='$participants',date_start='$start',date_finish='$finish',description='$description' where id='$id'")){
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> > <a href="literacy.php">Teachers Programmes</a> > edit</div>
  </div>
<!--End-breadcrumbs-->
          ...
          <form action="" method="POST" class="form-horizontal">
            <div class="control-group">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="school" value="<?php echo $fetch['school']; ?>" class="span11" required>
              </div>
            </div>
            <div class="control-group">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="number" name="participants" value="<?php echo $fetch['participants']; ?>" class="span11" required>
              </div>
            </div>
          <div class="control-group">
  ...
  <div class="span7">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            ...
            <h5>Literacy Programmes table</h5>
              <div id="search">
          ...
          ?>
                <tr class="odd gradeX">
                  ...
                  <td class="center"><a href="teachers_view.php?id=<?php echo $fetch['id'] ?>"><i class="icon icon-eye-open "></i></a>| <a href="teachers_edit.php?id=<?php echo $fetch['id'] ?>"><i class="icon icon-edit "></i></a> | <a href="teachers_delete.php?id=<?php echo $fetch['id'] ?>"><i class="icon icon-trash"></i></a></td>
