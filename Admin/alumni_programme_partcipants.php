...
if (isset($_POST['register'])) {
  ...
  $query = mysql_query("select * from alumni_programme_participants where email='$email'");

  $fetch = mysql_fetch_assoc($query);
  if($fetch['email'] == $email){
      $sms = "<p class='alert alert-error'>Participant already exist</p>";
  }else{
      if(mysql_query("insert into alumni_programme_participants values('','$program_id','$name','$email','$pnumber')")){
...
?>
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> > <a href = "javascript:history.back()">Alumni Programme</a> > <?php echo $fetch['program'];?> > Participants</div>
  </div>
<!--End-breadcrumbs-->
 ...
 <div class="span5">
    <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Register Participants for <?php echo $fetch['program'];?></h5>
        </div>
        ...
        <center><?php if(isset($sms)){echo $sms;} ?></center>
          <form action="" method="POST" class="form-horizontal">
            ...
            <div class="form-actions">
              <button type="submit" name="register" class="btn btn-success">Add Participants</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="span7">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
            ...
            <h5><?php echo $fetch['program'];?> Participants</h5>
          ...
          <div class="widget-content nopadding">
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
               <?php
               $query = mysql_query("select * from alumni_programme_participants where program_id='$id'");
               if(mysql_num_rows($query) < 1){
                    echo "<p class='alert alert-error'>Ooops! No Participants yet! for ".$fetch['program']." Add some.</p>";
               }else{
            $query = mysql_query("select * from alumni_programme_participants where program_id='$id'");
