...
if (isset($_POST['edit'])) {
  ...
  if(mysql_query("update literacy set program='$program',school='$school',region='$region',date_start='$start',date_finish='$finish',description='$description' where id='$id'")){
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> > <a href="literacy.php">Libraries</a> > edit</div>
  </div>
<!--End-breadcrumbs-->
...
<!--Action boxes-->
 ...
 <div class="span5">
    <div class="widget-box">
        ...
        <?php
          $query = mysql_query("select * from literacy where id = '$id'");
        ...
        <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
          ...
          ?>
                <tr class="odd gradeX">
                  ...
                  <td class="center"><a href="library_view.php?id=<?php echo $fetch['id'] ?>"><i class="icon icon-eye-open "></i></a>| <a href="literacy_edit.php?id=<?php echo $fetch['id'] ?>"><i class="icon icon-edit "></i></a> | <a href="literacy_delete.php?id=<?php echo $fetch['id'] ?>"><i class="icon icon-trash"></i></a></td>
